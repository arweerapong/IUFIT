const a=`[
 ...
 },
 {
  ...
  "th": "แท็บ \\"ตารางฝึก\\" → เลือกท่าจากคลัง หรือเพิ่มเอง → ใส่เซ็ต/ครั้ง/น้ำหนัก (คาร์ดิโอใส่นาที) → บันทึก\\nอยากได้ตารางทั้งสัปดาห์ พิมพ์ \\"จัดตารางฝึกให้หน่อย\\" ได้เลยครับ",
  "en": "Workout tab → pick a move from the library or add your own → enter sets/reps/weight (minutes for cardio) → save.\\nWant a full week? Just type \\"build a workout plan\\".",
  "action": "go_workout",
  "btnTh": "เปิดท่าฝึก",
  "btnEn": "Open Workout"
 },
