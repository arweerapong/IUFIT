...
(function (root) {
  ...
  var FAMILIES = [
    ...
    { fam: 'yum_generic', keys: ['ยำ'], icon: 'yum_plate', cat: 'salad' },
    ...
    { fam: 'matcha', keys: ['มัทฉะ', 'ชาเขียว', 'มัทฉะมัคคิอาโต', 'ชาเขียวมัคคิอาโต', 'มัทฉะลาเต้', 'ชาเขียวลาเต้'], icon: 'matcha_latte', cat: 'drink' },
    { fam: 'coffee', keys: ['กาแฟ', 'ลาเต้', 'อเมริกาโน', 'คาปูชิโน', 'เอสเพรสโซ', 'มอคค่า', 'โอเลี้ยง', 'เอสเพรสโซ่', 'คิอาโต', 'แมคคิอาโต', 'มัคคิอาโต', 'มัคคิอาโต้', 'แมคคิอาโต้', 'macchiato'], icon: 'cafe_latte', cat: 'drink' },
  ...
  function drinkByName(n) {
    ...
    if (/กาแฟ|ลาเต้|อเมริกาโน|คาปูชิโน|โอเลี้ยง|มอคค่า|คิอาโต|เอสเพรสโซ|macchiato/i.test(n)) return 'cafe_latte';
  ...
  function matchFoodIcon(input) {
    ...
    var HARDKW=[['แหนม','naem'],['ซอสหอยนางรม','oyster_sauce_bottle'],['น้ำจิ้มไก่','chili_sauce_bowl'],['น้ำจิ้มสุกี้','chili_sauce_bowl'],['ตับ','liver'],['ซาลาเปา','baozi'],['ขนมจีบ','siu_mai'],['หมูกรอบ','crispy_pork'],['ขาหมู','pork_leg_rice'],['กล้วยทอด','banana_fritters'],['สังขยาฟักทอง','pumpkin_slice'],['กาแฟร้อน','hot_coffee_mug'],['ชาร้อน','hot_tea_mug'],['โกโก้ร้อน','hot_cocoa_mug'],['ช็อกโกแลตร้อน','hot_cocoa_mug'],['ช็อคโกแลตร้อน','hot_cocoa_mug'],['เนื้อย่างข้าวเหนียว','grilled_beef_sticky_rice']];
