...
const CACHE='iufit-v810-logo-jackfruit';
const FILES=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./iufit-modern-theme.css','./food-db.js','./resultcard.html','./iufit-iu-mate.css','./iufit-iu-mate.js','./iufit-icons.js','./iufit-master-icons.js','./food-icon-normalizer.js','./food-icon-matcher.js','./food-icon-menu-mapping.js'];
