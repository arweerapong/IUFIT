...
const CACHE='iufit-v693-today-v17';
const FILES=['./','./index.html','./manifest.json','./icon-192.png','./icon-512.png','./iufit-modern-theme.css','./food-db.js','./resultcard.html','./iufit-iu-mate.css','./iufit-iu-mate.js','./iufit-icons.js'];
