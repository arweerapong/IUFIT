...
var KNOWLEDGE = [
  ...
  { id:'how_to_menu_library', cat:'app_help', kw:['คลังเมนู','เมนูทั้งหมด','ค้นเมนู','เพิ่มเมนู','เพิ่มวัตถุดิบ','ai เมนู','menu library','add menu','add ingredient'],
    ...
    actions:[{label:L('เปิดหน้าอาหาร','Open Food'),action:'go_food'}] },
  { id:'how_to_missions', cat:'app_help', kw:['ภารกิจ','mission','challenge','ตราสะสม','badge','เก็บตรา','collection','พิเศษ','special','กรอบ','frame','หายาก','rarity'],
    title:L('ภารกิจ & ตราสะสม','Missions & badges'),
    answer:L('ภารกิจคือเป้าหมายที่ทำสำเร็จแล้วได้ตราสะสม (badge) ดูคลังตราของคุณได้ที่การ์ด "ตราของฉัน" หน้าวันนี้ — ตรามีหลายระดับความหายาก และมีตรา ✨ พิเศษ (สัตว์/เทพนิยาย) หายากมาก กรองดูได้ด้วยตัวกรอง ระดับความหายาก/สัญลักษณ์/พิเศษ และนำตราที่ปลดล็อกแล้วมาประดับเป็นกรอบรูปโปรไฟล์ได้ที่ ตั้งค่า → โปรไฟล์ · โค้ชสร้างภารกิจให้ลูกเทรนได้ที่แท็บภารกิจ','Missions are goals you complete to earn collectible badges — open My badges on Today. Badges come in rarity tiers plus ✨ Special ones (animals/legends) that are ultra-rare; filter by rarity/symbol/Special, and equip any unlocked badge as a profile-photo frame in Settings → profile. Coaches create client missions in the Missions tab.'),
