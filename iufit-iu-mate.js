...
var KNOWLEDGE = [
  ...
  { id:'app_overview', cat:'app_help', kw:['ทำอะไรได้บ้าง','มีหน้าอะไร','ฟีเจอร์','แนะนำฟีเจอร์','สอนใช้งานทั้งหมด','สอนใช้แอป','สอนใช้งานแอป','ภาพรวมแอป','แอปมีอะไร','หน้าไหนทำอะไร','what can this app do','features','app overview','all features'],
  ...
  { id:'how_to_log_food', cat:'app_help', kw:['บันทึกอาหาร','เพิ่มอาหาร','ลงอาหาร','จดอาหาร','บันทึกมื้อ','สอนบันทึกอาหาร','จำนวนจาน','ปรับปริมาณ','กี่จาน','ปรับจาน','ครึ่งจาน','จานใหญ่','ปริมาณที่กิน','log food','add food','portion','servings'],
  ...
  { id:'how_to_log_workout', cat:'app_help', kw:['บันทึกท่าฝึก','ตารางท่าฝึก','ตารางฝึก','ดูตารางฝึก','คลังท่า','ออกกำลัง','จดท่าฝึก','สอนตารางฝึก','log workout','add workout','workout schedule'],
    title:L('วิธีบันทึกการออกกำลังกาย','How to log a workout'),
    answer:L('แท็บ "ท่าฝึก" มี 2 ส่วนด้านบน: 📋 "ตารางฝึก" (แผนรายวัน) และ 📚 "คลังท่า" (ครบทุกส่วน: อก/หลัง/ไหล่/แขน/ขา/ท้อง/คาร์ดิโอ/ยืดเหยียด/กีฬา)\nจัดตาราง + เพิ่มท่า:\n1) เข้า "ตารางฝึก" — แต่ละวันมีปุ่ม "＋ เพิ่มท่า"\n2) กด "＋ เพิ่มท่า" → คลังท่าเด้งขึ้น พิมพ์ที่ช่อง "ค้นหาท่า..." หรือเลือกตามหมวด\n3) ที่แต่ละท่า: แตะ ▶ ดูวิธีเล่นใน YouTube · แตะ ＋ เพิ่มท่าลงวันนั้น (เพิ่มได้หลายท่า)\n4) เพิ่มแล้ว แตะป้ายเซ็ตเพื่อแก้ "น้ำหนัก × ครั้ง × เซ็ต"\n💡 อยากบันทึกว่าเล่นวันนี้เลย แตะท่า → "บันทึกลงวันนี้" (ใส่แคลที่เผาได้) · หรือพิมพ์ "จัดตารางฝึกให้หน่อย"','The "Workout" tab has 2 parts: "Schedule" (daily plan) and "Move library". Build & add moves: 1) Open "Schedule" — each day has "＋ Add move". 2) Tap it → library opens; use "Search exercises..." or pick a category. 3) Per move: tap ▶ (YouTube), tap ＋ to add to that day (multiple ok). 4) Tap the set label to edit "weight × reps × sets". 💡 To log today, tap a move → "Log today".'),
    actions:[{label:L('เปิดท่าฝึก','Open Workout'),action:'go_workout'},{label:L('🗓️ จัดตารางฝึกให้เลย','Build my plan'),action:'_chip',payload:{q:L('จัดตารางฝึกให้หน่อย','build a workout plan')}}] },
