...
(function(){
  ...
  /* ⭐ 2569-09-22 · เปิดแล้ว — Omise ปรับเพดานเป็น ฿10,000 · รายปีแพงสุดวันนี้ ฿7,990 (Growth)
     ด่าน verify-billing-guard บังคับว่าราคารายปีทุกใบต้องไม่เกินเพดาน ถ้าเปิดธงนี้ */
  var YEARLY_OPEN=true;
  ...
  var MAX_THB_PER_CHARGE=10000; // 🪦 เดิม 1000 · Omise ปรับเป็น 10,000 (2569-09-22)
  ...
  var T={
    th:{
      ...
      ob_tab_me:'สำหรับผู้ใช้ทั่วไป', ob_tab_coach:'สำหรับโค้ช',
...
res_success_m:'แพ็กของคุณเปิดใช้งานแล้ว · เปิดแอป IUFIT ด้วยบัญชีเดิม แพ็กจะปลดล็อกอัตโนมัติภายในไม่กี่วินาที',
    ...
    en:{
      ...
      ob_tab_me:'For everyday users', ob_tab_coach:'For coaches',
