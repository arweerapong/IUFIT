...
res_success_m:'แพ็กของคุณเปิดใช้งานแล้ว · เปิดแอป IUFIT ด้วยบัญชีเดิม แพ็กจะปลดล็อกอัตโนมัติภายในไม่กี่วินาที',
      ...
      cr_need_email_m:'เปิดจากปุ่มในแชท LINE ที่บอทส่งให้ตอนเชื่อมบัญชี — ไม่ต้องกรอกเมล · หรือกรอกเมลที่ยืนยันในแอปด้านบน',
      ...
      wal_no_acct:'เปิดจากปุ่มในแชท LINE ที่บอทส่งให้ตอนเชื่อมบัญชี · หรือกรอกเมลที่ยืนยันในแอปด้านบน',
      wal_oa_hint:'กดปุ่มในแชทที่บอทส่งให้ตอนเชื่อมบัญชี — ไม่ต้องพิมพ์ «ยอดของฉัน» และไม่ต้องกรอกเมล',
    ...
    en:{
      ...
      cr_need_email_m:'Open the button the bot sent when you linked LINE — no e-mail needed. Or type the verified address above.',
      ...
      wal_no_acct:'Open the button the bot sent when you linked LINE · or enter the verified e-mail above',
      wal_oa_hint:'Tap the button the bot sent when you linked — no need to type “my credits” or enter e-mail',
